...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-between  w-full max-w-lg pb-2 text-sm border-b-2 lg:gap-28 lg:max-w-5xl lg:justify-normal ",
      className
    )}
    {...props}
  />
